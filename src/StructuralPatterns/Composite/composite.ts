...
abstract class Component {
    ...
    /**
     * You can provide a method that lets the client code figure out wether a component can bear children.
     */
...
/**
 * The Leaf class represents the end objects of a comopsition.
 *
 ...
 *
 * Usually, the Composite objects delegates the actual work to their children and then "sum-up" the result.
 */
class Composite extends Component {
    protected children: Component[] = [];

    /**
     * A composite object can add or remove other components (both simple or complex) to or from its clild list.
     */
    public add(component: Component): void {

 ...
 *
 * Concrete subclasses should implement these operation, but leave the template method itself intact.
 */
abstract class AbstractClass {
     ...
     *
     * Hooks provide additionl extension points in some crucial places of the algorithm.
     */
